...
void ShopSystem::restock() {
    currentStock.clear();
    // Memasukkan kelima Joker hasil gabungan TDD ke dalam etalase toko
    currentStock.push_back(JokerType::Basic);
    currentStock.push_back(JokerType::FlatChip);
    currentStock.push_back(JokerType::Pair);
